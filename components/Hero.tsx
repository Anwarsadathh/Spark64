  ...
  return (
    <>
      <style>{`
        ...
        @keyframes s64-bounce {
          0%,100% { transform:translateY(0);   }
          50%     { transform:translateY(6px);  }
        }

        /* King — inline beside wordmark */
        .hero-piece {
        ...
        .hero-btn-row {
          ...
          gap:10px; width:100%; max-width:430px;
          justify-content:center;
        }
        .hero-btn-primary {
          flex:1;
        ...
        @media (prefers-reduced-motion:reduce) {
          .hero-piece,.hero-cr,.hero-cl,.s64-scroll,.hero-stat-card,
          .hero-wcd-dot { animation:none!important; }
      ...
      >
        {/* Dark gradient overlay — same as old design */}
        <div
        ...
        {/* 3-D perspective chessboard */}
        <canvas
          ref={canvasRef} width={560} height={560} aria-hidden="true"
        ...
        <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center
                        px-5 pb-16 pt-14 text-center sm:px-8 sm:pb-24 sm:pt-20 md:pt-28">

          {/* World Chess Day banner */}
          <motion.div variants={fadeUp} initial="hidden" animate="show" custom={0}>
            <span className="hero-wcd-bar">
              <span className="hero-wcd-dot" aria-hidden="true"/>
              Golden opportunity on World Chess Day — 20 July 2026
            </span>
          </motion.div>
          ...
          {/* Wordmark + King inline — left side only */}
          <motion.div
